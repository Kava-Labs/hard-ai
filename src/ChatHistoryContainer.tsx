  ...
  const conversations: ConversationHistory[] = [
    {
      ...
      conversation: [
        ...
        {
          role: "user",
          content: "Can you help me plan a new web application project? I want to build a task management system."
        },
      ],
      lastSaved: Date.now(),
    ...
    },
    {
      ...
      conversation: [
        ...
        {
          role: "user",
          content: "I'm hosting a dinner party this weekend and need some vegetarian main course ideas that will impress my guests."
        },
      ],
      lastSaved: Date.now(),
    ...
    },
    {
      ...
      conversation: [
        ...
        {
          role: "user",
          content: "I have a CSV file with sales data for the past year. I need to analyze it to find trends. What's the best way to do this with Python?"
        },
      ],
